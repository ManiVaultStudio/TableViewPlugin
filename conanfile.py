...
class TableViewPluginConan(ConanFile):
    ...
    description = """Plugins for displaying TableView in ManiVaultStudio."""
    topics = ("hdps", "plugin", "image data", "loading")
    url = "https://github.com/ManiVaultStudio/TableViewPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/TableViewPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/TableViewPlugin")
        cmake.verbose = True
        return cmake
